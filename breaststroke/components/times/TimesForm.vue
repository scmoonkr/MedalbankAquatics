...
<template>
  <div>
    ...
    <FindSelectPool title="수영장1을 선택해주세요." v-model="selectedPool" width="large" @update:modelValue="onPoolChange" />
...
import FindSelectTeam from '~/components/teams/TheFindSelectTeam.vue';
import FindSelectPool from '~/components/pools/TheFindSelectPool.vue';
