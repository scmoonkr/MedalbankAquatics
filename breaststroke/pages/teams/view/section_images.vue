<template>
  <div class="image-cards-container">
    <TheImageCard_0 :team="team" :medals="medals" :date="dateStr" width="normal" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_1 :team="team" :medals="medals" :date="dateStr" width="normal" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_2 :team="team" :medals="medals" :date="dateStr" width="normal" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_0 :team="team" :medals="medals" :date="dateStr" width="narrow" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_1 :team="team" :medals="medals" :date="dateStr" width="narrow" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_2 :team="team" :medals="medals" :date="dateStr" width="narrow" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_3 :team="team" :medals="medals" :date="dateStr" width="normal" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />

    <TheImageCard_0 :team="team" :medals="medals" :date="dateStr" width="wide" :card-height="height"
      :background-image="selectedImage" :text-color="selectedTextColor" />
  </div>
...
const defaultImage = ""; //"https://i.ibb.co/BK3ftvbn/team-23-featured.jpg";
...
// team 객체 변경 감지 및 이미지 업데이트
watch(() => props.team, (newPool) => {
...
onMounted(() => {
  let featured = props.team.featured ?? "";
  featured = featured.includes("http") ? featured : apiBase + featured;
  selectedImage.value = featured;
...
async function saveImageToServer() {
  ...
  try {
    ...
    // teamID: number, imageURL: string, userID: number
