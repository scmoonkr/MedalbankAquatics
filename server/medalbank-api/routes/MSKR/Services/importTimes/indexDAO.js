...
exports.updateTime = async (body) => {
	...
	const result = await mongodb.updateOne(mongoCFG.Medalbank.timesImport, query, value);
...
exports.deleteTime = async (body) => {
	...
	let result = await mongodb.deleteOne(mongoCFG.Medalbank.timesImport, query);
	return returnObj;
}
