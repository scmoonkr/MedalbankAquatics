...
result = await mongodb.updateManyOP(mongoCFG.Breaststroke.athletes, {}, clear);

//-----> clear competitions
clear = { $unset: { styleDistances:1, athleteCount:1, timeCount:1, bestTimes:1, } };
result = await mongodb.updateManyOP(mongoCFG.Breaststroke.competitions, {}, clear);

//-----> clear stems
clear = { $unset: { competitionCount:1, athleteCount:1, timeCount:1, bestTimes:1, } };
result = await mongodb.updateManyOP(mongoCFG.Breaststroke.stems, {}, clear);

//-----> clear pools
clear = { $unset: { athleteCount:1, timeCount:1, medals:1, members:1, points:1, rank:1, style:1, } };
result = await mongodb.updateManyOP(mongoCFG.Breaststroke.pools, {}, clear);

//-----> clear teams
clear = { $unset: { athleteCount:1, timeCount:1, medals:1, members:1, points:1, rank:1, style:1, } };
result = await mongodb.updateManyOP(mongoCFG.Breaststroke.teams, {}, clear);
