...
<div class="modal-overlay" id="recordModal" hidden>
    ...
    <section class="modal-block">
      <div class="modal-block-head">
        ...
        <div class="section-info-popover" id="info-canon-compare" hidden>
          <p>세계(WR) · 올림픽(OR) · 아시아(AR) · 한국(KR) · 세계마스터즈(WMR) · 한국마스터즈(KMR)
          <strong>여섯 가지 권위 기록</strong>을 한눈에 비교합니다. 각 기록은
          <strong>World Aquatics · 국제올림픽위원회 · 아시아 수영연맹(AASF) ·
          대한수영연맹 · World Aquatics Masters</strong>가 공식 공인한 기록입니다.</p>
        </div>
      </div>
  ...
  function renderSpeed() {
    ...
    const COMPARE_CODES = ['WR', 'KR', 'WMR', 'KMR'];
