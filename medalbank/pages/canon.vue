...
const RECORD_TYPES = [
  ...
  { code: 'AR',  ko: '아시아 기록'        },
  { code: 'KR',  ko: '한국 기록'          },
  { code: 'WMR', ko: '세계 마스터즈 기록' },
  { code: 'KMR', ko: '한국 마스터즈 기록' },
  { code: 'ER',  ko: '인핸스드 게임 기록' },
]
...
const EVENTS = [
  ...
  { gender:'M', stroke:'BA', distance:50   }, { gender:'W', stroke:'BA', distance:50   },
  { gender:'M', stroke:'BA', distance:100  }, { gender:'W', stroke:'BA', distance:100  },
  { gender:'M', stroke:'BA', distance:200  }, { gender:'W', stroke:'BA', distance:200  },
...
onMounted(() => {
  ...
  loadScript('/canon/js/scoring.js')
    ...
    .catch(err => console.error('[canon] script load error', err))
})
</script>
